...
const errorPageStyles = (theme)=>({
        ...
        title: {
            ...
            ..._styles_jss_novel_logiks_js__WEBPACK_IMPORTED_MODULE_0__/* .title */ .TN,
            fontSize: "13.7em",
            color: _styles_jss_novel_logiks_js__WEBPACK_IMPORTED_MODULE_0__/* .whiteColor */ .zQ,
        ...
        pageHeader: {
            ...
            alignItems: "center",
            "&:before": {
                background: "rgba(" + (0,_styles_jss_novel_logiks_js__WEBPACK_IMPORTED_MODULE_0__/* .hexToRgb */ .oo)(_styles_jss_novel_logiks_js__WEBPACK_IMPORTED_MODULE_0__/* .blackColor */ .FT) + ", 0.5)"
            },
            "&:before,&:after": {
                position: "absolute",
                zIndex: "1",
